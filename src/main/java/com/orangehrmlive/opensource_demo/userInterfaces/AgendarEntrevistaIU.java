...
public class AgendarEntrevistaIU {
    ...
    public static final Target OPTION_SELECT_INTERVIEWER = Target.the("Option interviewer list").locatedBy("//input[@name='interviewer']/following-sibling::div[@class='oxd-select-option'][1]");
